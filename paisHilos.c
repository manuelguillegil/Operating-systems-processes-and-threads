...
/*Esta funcion es llamada para encontrar una accion y ejecutarla*/
void doAccion(FILE* fp, char* quienInvoco){
    size_t len = 0;
    char* line;
    int Encontro = FALSE;
